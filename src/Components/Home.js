...
//                             {/*replace image here*/}
//                             <img className={'rounded my-auto image col-5'} src={balloon} alt="Hashbrowwn balloon"/>
//                             <div className={'rect rounded col-7'}>
//                                 <div className={'text-field col-8'}>
...
//                         <div className={'row mt-5 justify-content-center col-12'}>
//                             <img className={'rounded my-auto project-pic col-4'} height={'280px'} src={emissions} alt="Emissions simulation"/>
...
//
//                         <div className={'row mt-5 justify-content-center col-12'}>
//                             <img className={'rounded my-auto project-pic col-4'} height={'280px'} src={ballista} alt="Ballista"/>
//                             <div className={'project-rect rounded col-8'}>
//                                 <div className={'project-text-field'}>
//                                     {/*Replace Name here*/}
